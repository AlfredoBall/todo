...
output "app_registration_service_principal_id" {
  ...
  value       = azuread_service_principal.app_registration_sp.object_id
}

output "app_registration_scope_uri" {
  description = "API scope for authentication"
  value       = "api://${azuread_application.app_registration.client_id}/access_as_user"
}

output "app_registration_audience" {
  description = "API audience URI"
  value       = "api://${azuread_application.app_registration.client_id}"
}