...
resource "azurerm_linux_web_app" "frontend" {
	...
	site_config {
		always_on = false
		app_command_line = "cp /home/site/wwwroot/nginx.conf /etc/nginx/sites-available/default && cp /etc/nginx/sites-available/default /etc/nginx/sites-enabled/default && service nginx reload"
